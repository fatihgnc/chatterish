...
export interface AuthServiceClient extends grpc.Client {
  SignUserIn(argument: _chatterish_UserCredentials, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  SignUserIn(argument: _chatterish_UserCredentials, metadata: grpc.Metadata, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  SignUserIn(argument: _chatterish_UserCredentials, options: grpc.CallOptions, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  SignUserIn(argument: _chatterish_UserCredentials, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  signUserIn(argument: _chatterish_UserCredentials, metadata: grpc.Metadata, options: grpc.CallOptions, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  signUserIn(argument: _chatterish_UserCredentials, metadata: grpc.Metadata, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  signUserIn(argument: _chatterish_UserCredentials, options: grpc.CallOptions, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
  signUserIn(argument: _chatterish_UserCredentials, callback: grpc.requestCallback<_chatterish_Token__Output>): grpc.ClientUnaryCall;
...
export interface AuthServiceHandlers extends grpc.UntypedServiceImplementation {
  SignUserIn: grpc.handleUnaryCall<_chatterish_UserCredentials__Output, _chatterish_Token>;
...
export interface AuthServiceDefinition extends grpc.ServiceDefinition {
  SignUserIn: MethodDefinition<_chatterish_UserCredentials, _chatterish_Token, _chatterish_UserCredentials__Output, _chatterish_Token__Output>
